...
import { renderRemovePage, removeEmployee, renderBossesPage } from '../../controllers/web/adminController.js';
...
//router.get('/manage-employees', requireAdmin, manageEmployees);
